...
exports.saveAnswer = async (req,res) => {
    const score = {result: parseInt(req.body.a1) + parseInt(req.body.a2) + parseInt(req.body.a3) + parseInt(req.body.a4) + parseInt(req.body.a5),
    mydata: ""
    }
    res.status(200).render('results', score)
}
